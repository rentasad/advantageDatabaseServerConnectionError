...
public class AdsConnectionTest
{
	...
	{
		String host = "//192.168.0.161";
		//		String host = "//192.168.130.10";
		String socket = "6262";
		String databaseDictionaty = "C:\\PROGRA~2\\ADVANT~2.10\\Help\\ADS_DATA\\";
	...
	@Test public void encodingCheckQuarterAddress() throws Exception
	{
		...
		String host = "//192.168.112.114";
		String socket = "6262";
		String databaseDictionaty = "C:\\Program Files (x86)\\Advantage 10.10\\Help\\ADS_DATA";
		String lockType = "proprietary";
		String charType = "OEM";
		String tableType = "cdx";
